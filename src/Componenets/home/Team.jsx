            ...
            <div className="row d-flex justify-content-evenly align-items-center gap-3 feature_container"
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                    <div className="team-box">
                        ...
                        <div data-cursor="pointer" className="link-overflow"><Link href="">Read more <FontAwesomeIcon icon={icon} style={{color: "grey", paddingTop: "4px"}} /></Link>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-sm-6">
                    <div className="team-box">
                        ...
                        <div data-cursor="pointer" className="link-overflow"><Link
                                href="" target="_blank">Read more <FontAwesomeIcon icon={icon} style={{color: "grey", paddingTop: "4px"}} /></Link>
                        </div>
                    </div>
                </div>
            </div>
