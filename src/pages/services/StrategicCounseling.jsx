    ...
    <>
      ...
      <div className="container">
        <div className="service-info" style={{ position: 'relative', marginBottom: '5rem' }}>
          <div>
            <div className="title">
              <h4 style={{ color: '#00BDFF' }}>Real Clients, Real Success</h4>
              <h2 className="text-white">What <span style={{ color: '#ffce00' }}>Our Clients</span> Are Saying</h2>
            </div>
            <p className="service_paragraph">
              Explore How Our AI Solutions and Training Empower Businesses to Save Time, Increase Conversions, and Elevate Customer Experiences
            </p>
          </div>
        </div>
        <Swiper
