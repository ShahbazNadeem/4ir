...
const AitalkAssist = () => {
    ...
    const Box = [
        ...
        },
        {
            ...
            title: "Provide 24/7 customer support without the need for additional staff.",
                ...
                <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky">
                    <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <Link class="nav-link" style={{paddingBottom:"10px"}} href="#feature-section">Features</Link>
                                </li>

                                <li class="nav-item">
                                    <Link class="nav-link" href="#how-it-work">How It Works</Link>
                                </li>

                            <li class="nav-item">
                                <Link class="nav-link" href="#testimonial-section">Testimonials</Link>
                            </li>
                                <li class="nav-item">
                                    <Link class="nav-link" href="#faq-section">FAQ</Link>
                                </li>
